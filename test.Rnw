...
% \begin{figure}[h]
%    \centering
%    \includegraphics[width=\linewidth]{./paper_sr_format/linearpattern.png}
...
\begin{figure*}[h]
   \centering
   \includegraphics[width=\linewidth]{./code/output/syntheticsynthetic_patterns.jpg}
...
\begin{figure*}[h]
   \centering
    \includegraphics[width=\linewidth]{./code/output/syntheticgeospace_zones.jpg}
...
% 	\begin{minipage}{\linewidth}
%    \centering
%     \includegraphics[width=\linewidth]{./code/output/syntheticgeospace_frequency.jpg}
...
% 	\begin{minipage}{\linewidth}
% 		\centering
%    		\includegraphics[width=\linewidth]{./code/output/syntheticsynthetic_patterns_phasespace.jpg}
...
The Authors thank Prof. Mike Batty, Dr. Cl\'ementine Cottineau, Susanne Gartner, Dr. R\'emi Louf, Dr. Carlos Molinero, Dr. (??) Robin Morphet, Hadrien Salat (alphabetically) for useful discussions and support. M.B. and E.A. were partly funded by the MECHANICITY Project (249393 ERC-2009-AdG) ??. E.A. was partly funded by ????? (current grant??) Did I forget anyone??
