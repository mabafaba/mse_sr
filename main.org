...
* PLAN
  - today:
    ...
    - [ ] run 150x real&null
    - [ ] save
    - [ ] remove confidence intervals from time plots 
  -tomorrow:
    - morning:
      - [ ] read top to bottom
        - [ ] spell check
...
- [ ] properly acknowledge the one paper that does exactly the same (does it though? -> understand them with thought experiment!)
    - [ ] essential: they ask: does larger scale follow from smaller scale?
    - [ ] I say: larger scale IS composition of smaller scale, and the smaller scale around..
