...
In contrary to thermodynamics where usually there is a general consesus about what the degrees of freedom of a system are, there are fundamental differences between interpretations of entropy in cities, and they come down to different definitions of the phase space dimensions.
\begin{itemize}
