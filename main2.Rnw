...
In this chapter we summarised existing measures of entropy in cities, developed a new multiscale phase space definition and a method to estimate multiscale entropy. In the following chapter it is applied to simulated patterns. 
