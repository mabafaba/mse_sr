...
\begin{figure}[ht]
   ...
   \caption{black pixel frequencies in the zones of the geographical phase space, patterns a) - \Sexpr{synthfig_letters[length(synthfig_letters)]} in figure \ref{fig:synthetic}}
