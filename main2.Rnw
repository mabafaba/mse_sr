\documentclass[article,10pt]{./paper_sr_format/wlscirep}
\usepackage{float}
\usepackage[utf8]{inputenc}

\title{Multiscale Entropy in the Spatial Context of Cities}
\author[1,*]{Martin Barner}
\author[2]{Dr. Kiril Stanilov}
\author[3]{Dr. Elsa Arcaute}

\affil[1,3]{Centre for Advanced Spatial Analysis, University College London, 90 Tottenham Court Road, London W1N 6TR, UK}
...
\keywords{entropy, complexity, cities, urban, spatial, scale, statistical mechanics}
...
Entropy relates the microscopic behaviour of elements in a system to its macroscopic state. We propose to use entropy to explain how small scale individual decisions form cities: we offer a new interpretation of urban entropy for cities that reflects interaction between different places with interdependent microstates. We construct an associated measure with a multiscale approach.
With simulated patterns we show that in spatial systems with interactions across multiple scales, structural complexity could occur through entropy maximisation. In the distribution of functions in West London from 1875 to 2005, we can partly explain the occurance of polycentric sprawl through a greater entropy increase compared to spatially random spread, compact mixed-use growth or fully segregated patterns.
This work contributes to understanding why cities are morphologically complex as a result of small scale interactions, and further proposes a consistent relationship between entropy and complexity in response to conflicting literature. Finally the general framework of thinking could be applied to in planning practice to incorporate uncertainty about the future into physical designs.
\end{abstract}
\begin{document}
...
\begin{itemize}
\item{It should observe how places are distributed across characteristics, to reflect the certainty about how the city is used.}
...
% \begin{figure}[ht]
%    \centering
%    \includegraphics[width=0.8\textwidth]{./paper_sr_format/linearpattern.png}
...
\begin{figure}[ht]
   \centering
   \includegraphics[width=0.8\textwidth]{./code/output/syntheticsynthetic_patterns.jpg}
...
% \begin{figure}[ht]
%    \centering
%     \includegraphics[width=0.8\textwidth]{./code/output/syntheticgeospace_zones.jpg}
...
\begin{figure}[ht]
	\begin{minipage}{.5\textwidth}
	   \centering
	    \includegraphics[width=.95\textwidth]{./code/output/syntheticgeospace_entropy.jpg}
	...
	\begin{minipage}{.5\textwidth}
   \centering
    \includegraphics[width=.95\textwidth]{./code/output/syntheticgeospace_frequency.jpg}
...
\begin{figure}[ht]
	\begin{minipage}{.5\textwidth}
	   \centering
	    \includegraphics[width=0.9\textwidth]{./code/output/syntheticboxplot.jpg}
	...
	\begin{minipage}{.5\textwidth}
		\centering
   		\includegraphics[width=0.9\textwidth]{./code/output/syntheticsynthetic_patterns_phasespace.jpg}
...
The multiscale entropies and confidence intervals in figure \ref{fig:real_vs_null_entropies} show that the observed multiscale entropy of West London is substantially higher than all three null models. Especially between 1915 and 1960, entropy increases considerably in the observed data, while the null models stagnate. \\
...
\begin{figure}[ht]
   \centering
    \includegraphics[width=0.5\textwidth]{./code/output/real_vs_null_entropies.jpg}
...
\begin{figure}[ht]
   \centering
    \includegraphics[width=0.8\textwidth]{./code/output/real_vs_null_rasters.jpg}
